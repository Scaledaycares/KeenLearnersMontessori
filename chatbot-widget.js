...
function startConversation() {
    fetch('https://chatbot-for-keen-learners-montessori-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
   ...
   // sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-keen-learners-montessori-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyzDc55C-CQTv13Plu66GPkKQe0zirmuJI6BskjeXKnQ2-6J__l_MHkSdGgybzlr95oYg/exec';
